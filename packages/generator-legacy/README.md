# @paljs/generator-legacy

> **DEPRECATED**: This package is deprecated. Use `@paljs/generator` with Prisma 7 instead.
>
> The new `@paljs/generator` runs as a true Prisma generator during `prisma generate` and provides better type safety and Prisma 7 support.
>
> See the [Migration Guide](../../docs/MIGRATION-v9.md) for upgrade instructions.
...
```bash
npm install @paljs/generator-legacy
# or
yarn add @paljs/generator-legacy
# or
pnpm add @paljs/generator-legacy
```
...
```typescript
import { Generator } from '@paljs/generator-legacy';
...
```typescript
import { GenerateNexus } from '@paljs/generator-legacy';
...
```typescript
import { GenerateSdl } from '@paljs/generator-legacy';
...
```typescript
import { GenerateModules } from '@paljs/generator-legacy';
...
```typescript
import { UIGenerator } from '@paljs/generator-legacy';
...
```typescript
import { GenerateNexus, GenerateSdl } from '@paljs/generator-legacy';
...
```typescript
import type { GeneratorOptions, QueriesAndMutations, AdminPagesOptions } from '@paljs/generator-legacy';

...
- Fix import path issues causing "Element type is invalid" error
- Changed relative imports from '..' to proper '../types' paths

## 9.0.0-beta.1

### Patch Changes

- Fix workspace protocol dependency issue - properly resolve @paljs/types version
...
- upgrade prisma version to 6.11
